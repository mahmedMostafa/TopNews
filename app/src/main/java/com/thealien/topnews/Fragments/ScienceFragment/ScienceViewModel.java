...
import static com.thealien.topnews.Utilities.Urls.SCIENCE_NEWS_URL;

public class ScienceViewModel extends ViewModel {

    private static final String TAG = "ScienceViewModel";
    ...
    private void loadData(Context context) {
        ...
        Uri baseUri = Uri.parse(SCIENCE_NEWS_URL);
